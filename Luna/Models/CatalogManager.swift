...
class CatalogManager: ObservableObject {
    ...
    private func loadCatalogs() {
        ...
        let defaultCatalogs: [Catalog] = [
            ...
            Catalog(id: "networks", name: "Network", source: .tmdb, isEnabled: true, order: 3, displayStyle: .network),
            Catalog(id: "nowPlayingMovies", name: "Now Playing Movies", source: .tmdb, isEnabled: false, order: 4),
            Catalog(id: "upcomingMovies", name: "Upcoming Movies", source: .tmdb, isEnabled: false, order: 5),
            Catalog(id: "popularTVShows", name: "Popular TV Shows", source: .tmdb, isEnabled: true, order: 6),
            Catalog(id: "genres", name: "Category", source: .tmdb, isEnabled: true, order: 7, displayStyle: .genre),
            Catalog(id: "onTheAirTV", name: "On The Air TV Shows", source: .tmdb, isEnabled: false, order: 8),
            Catalog(id: "airingTodayTV", name: "Airing Today TV Shows", source: .tmdb, isEnabled: false, order: 9),
            Catalog(id: "topRatedTVShows", name: "Top Rated TV Shows", source: .tmdb, isEnabled: true, order: 10),
            Catalog(id: "topRatedMovies", name: "Top Rated Movies", source: .tmdb, isEnabled: true, order: 11),
            Catalog(id: "companies", name: "Company", source: .tmdb, isEnabled: true, order: 12, displayStyle: .company),
            Catalog(id: "trendingAnime", name: "Trending Anime", source: .anilist, isEnabled: true, order: 13),
            Catalog(id: "popularAnime", name: "Popular Anime", source: .anilist, isEnabled: true, order: 14),
            Catalog(id: "featured", name: "Featured", source: .tmdb, isEnabled: true, order: 15, displayStyle: .featured),
